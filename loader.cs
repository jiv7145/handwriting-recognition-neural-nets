...
namespace WindowsFormsApp3
{
    class Loader
    {
        ...
        public List<List<Tuple<NDarray, NDarray>>> load_data(string file) {
            ...
            List<Tuple<NDarray, NDarray>> training_data = Util.zip(training_inputs, training_results);
            ...
            List<Tuple<NDarray, NDarray>> validation_data = Util.zip(validation_inputs, va_d[1]);
            ...
            List<Tuple<NDarray, NDarray>> test_data = Util.zip(test_inputs, te_d[1]);
